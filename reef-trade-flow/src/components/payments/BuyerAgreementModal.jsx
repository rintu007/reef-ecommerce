        ...
        <div className="bg-muted rounded-xl p-4 space-y-3 text-sm text-foreground max-h-72 overflow-y-auto">
          <div>
            ...
            <p className="text-muted-foreground">
              As a buyer, you pay the <strong>item price + any shipping the seller has set + sales tax. No platform fees or processing fees are ever added to your total.</strong> If a seller sets shipping to $0, you only pay item price + tax.
            </p>
