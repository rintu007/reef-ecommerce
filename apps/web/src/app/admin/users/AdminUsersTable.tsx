...
import { listAdminUsers, updateUserRole, type Profile } from "@reef-market/shared";
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          ...
          {users.map((user) => (
            <div key={user.id} className="flex items-center gap-3 rounded-xl border border-gray-200 p-3 bg-white">
